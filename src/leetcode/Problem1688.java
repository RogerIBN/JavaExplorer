...
public class Problem1688 {
    ...
    public static void main(String[] args) {
        System.out.println("1688. Count of Matches in Tournament");
        int n = 7;
        System.out.println("Input: n = " + n);
        int output = numberOfMatches(n);
    ...
    /**
     * Calculates the number of matches required to determine the champion in a
     * tournament with 'n' teams.
     *
